...
<body>
<form action="change.php" action="get">
	<table>
		<tr>
			<td>
		...
		<tr>
			<td>
				Contact No:<input type="text" name="txtctc_no">
			</td>
		</tr>
		<tr>
			<td>
				Address:<textarea name="txtadd"></textarea>
			</td>
		</tr>
		<tr>
			<td>
				State-Name:<select name="state" class="state" id="state">*
	
	
		
	
		
	<option value="Andra Pradesh">Andra Pradesh</option><option value="2">Arunachal Pradesh</option>
	...
	<option value="West Bengal">West Bengal</option>
		...
		<tr>
			<td>
				City-Name:<select name="cmbccity">
...
<option>Other</option>
		...
		<tr>
			<td>
				Post-code:<input type="text" name="txtpst">
			</td>
		</tr>
		<tr>
			</td>
